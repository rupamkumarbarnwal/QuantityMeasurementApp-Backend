...
public class QuantityMeasurementApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("App Volume Equality: "
        		+ demonstrateEquality(v1,v2));
       
        
        System.out.println("App Volume Converstion litre to millilitre: "+demonstrateConversion(v1,VolumeUnit.MILLILITRE));
        System.out.println("App Volume Addition: " +
